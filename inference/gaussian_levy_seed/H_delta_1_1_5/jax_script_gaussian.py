...
if __name__ == "__main__":
    ...
    TRUE_ENVELOPE_PARAMS = (1.,1.5)
    #TRUE_ENVELOPE_PARAMS  = (0.2,)
    np.random.seed(seed = 12411322)
    ...
    lags_list = ((1, 3, 5, 10, 15),)
    n_values = (4000,2000,1500, 1000, 500, 250)   
