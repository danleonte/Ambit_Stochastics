...
__all__ = ['modified_minimize', 'modified_minimize_scalar']
...
from modified_bfgs_script import (modified_minimize_bfgs,_wrap_callback)
...
def modified_minimize(fun, x0, args=(), method=None, jac=None, hess=None,
    ...
    **Custom minimizers**
    ...
    if meth == 'nelder-mead':
        ...
        res = modified_minimize_bfgs(fun, x0, args, jac, callback, hess_inv_initial_estimate = hess_inv_initial_estimate, **options)
    elif meth == 'newton-cg':
...
def modified_minimize_scalar(fun, bracket=None, bounds=None, args=(),
