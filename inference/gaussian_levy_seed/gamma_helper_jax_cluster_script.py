...
if __name__ == "__main__":
    ...
    nr_trawls = 1600
    nr_simulations = 100
    TRUE_GAMMA_PARAMS = (4, 0.9) #alpha, beta (rate) not alpha, theta (scale). trawl simulation uses alpha, scale, so need to pass 5, 1/2 there
    envelope = 'gamma'
    jax_seed = 243424
    ...
    n_values = (1500,1000,500,250)#(1000,500,250,150)#,1000, 2500, 5000)#,750,1000,1500)
